...
# 3. 預設資料庫 (包含瑞銀歐元高收益、富蘭克林、霸菱與富達真實數據)
PRESET_FUNDS = {
    "瑞銀歐元高收益債券基金": {
        ...
        "score": "75.0", # 💡 嚴格遵循規則點算後得分為 75.0 分
        ...
        "kpis": {
            "p1": "7.90%", # USD Hedged P-mdist 派息率
        ...
        "eval_table": [
            ["一、派息質量", "從資本派息 (ROC) 與總回報覆蓋率", "• 20分: ROC <10% 或 總回報 ≥ 派息率<br>• 10分: ROC 10%-50% 且總回報覆蓋率 >70%<br>• 0分: ROC >50% 且 總回報為負", "• 月報到期收益率：4.50% | 美元對沖派息率：~7.90%[cite: 4, 5]<br>• 每月分派高度依賴資本 (ROC 占 70%-100%)[cite: 5]<br>👉 單月分派資本補貼偏高，但全年度營運淨利 (€1.08億) 遠高於總派息 (€3,839萬)[cite: 3]。", "10 / 20", "<span class='status-badge-yellow'>⚠️ 資本補貼分派</span>"],
    ...
    "富蘭克林入息基金": {
        ...
        "score": "67.5",
        "summary": "富蘭克林入息基金依據簡算規則審視得分為 67.5 分 (中等風險)。純經常性利息淨收益 ($3.50億) 對總派息 ($5.73億) 覆蓋率為 61.1%，存在 $2.23 億缺口，需依賴股票資本利得 (Capital Gains) 或本金補充[cite: 3, 4]；申購 $66.73 億 vs 贖回 $34.23 億展現 +$3,249.83M 淨資金流入 (流動性極佳)[cite: 4]；存續期 4.24 年、前十大持倉 23.27% 及美國區域集中 (80.8%) 均反映在中等扣分項上[cite: 4]。",
        "kpis": {
            "p1": "8.37%",
        ...
        "eval_table": [
            ["一、派息質量", "從資本派息 (ROC) 與總回報覆蓋率", "• 20分: ROC <10% 或 總回報 ≥ 派息率<br>• 10分: ROC 10%-50% 且總回報覆蓋率 >70%<br>• 0分: ROC >50% 且 總回報為負", "• 月報到期收益率：6.11% | 現時派息率：~8.37%[cite: 3, 4]<br>• 經常性收益 ($3.50億) 對總派息 ($5.73億) 覆蓋率為 61.1% (< 70%)[cite: 4]<br>👉 經常性利息不足以全額支付派息，需依賴股票資本利得 (Capital Gains) 補足。[cite: 3, 4]", "10 / 20", "<span class='status-badge-yellow'>⚠️ 資本利得補貼/缺口</span>"],
            ["二、信用風險", "評級分佈與非投資級占比", "• 15分: 平均評級 BBB 以上<br>• 10分: 平均評級 BB 級<br>• 5分: Caa/CCC級 >10% 或未評級 >15%", "• 綜合平均評級：BB 級<br>• 高收益債占 19.17%[cite: 4]<br>👉 符合簡算規則 10 分級別 (平均評級 BB 級)。", "10 / 15", "<span class='status-badge-yellow'>⚠️ 中等風險</span>"],
            ["三、槓桿水平", "資產膨脹率 (Total / Net Assets)", "• 15分: 比率 <105% (無顯著槓桿)<br>• 10分: 比率 105%-120%<br>• 0分: 比率 >120% (槓桿過高)", "• 總資產 $8,878.70M / 淨資產 $8,817.35M = 100.69%[cite: 4]<br>👉 比率 < 105%，完全無顯著借貸槓桿。[cite: 4]", "15 / 15", "<span class='status-badge-green'>✔ 優秀</span>"],
            ["四、利率敏感度", "有效存續期 (Duration)", "• 10分: 存續期 <3 年 (抗升息)<br>• 5分: 存續期 3-6 年<br>• 0分: 存續期 >6 年", "• 有效存續期 (Effective Duration)：4.24 年[cite: 4]<br>👉 落在 3-6 年規則區間，符合 5 分規則。[cite: 4]", "5 / 10", "<span class='status-badge-yellow'>⚠️ 中等久期</span>"],
            ["五、流動性風險", "現金儲備與營運現金流", "• 10分: 現金 >10% 或流動性充沛且營運 Cash Flow 為正<br>• 5分: 現金 5%-10%<br>• 0分: 現金 <5% 或流動性緊縮", "• 現金 5.97% + 申購淨流入達 +$32.5 億美元[cite: 4]<br>👉 營運現金流極度充沛，符合 10 分規則。[cite: 4]", "10 / 10", "<span class='status-badge-green'>✔ 優秀</span>"],
            ["六、集中度風險", "前十大發行人持倉占比", "• 10分: 前持倉 <20% (極分散)<br>• 5分: 前持倉 20%-30%<br>• 0分: 前持倉 >30%", "• 前十大發行人持倉合計占：23.27%[cite: 4]<br>👉 落在 20%-30% 規則區間，符合 5 分規則。[cite: 4]", "5 / 10", "<span class='status-badge-yellow'>⚠️ 適中分散</span>"],
            ["七、匯率風險", "衍生品對沖與未實現損益", "• 10分: 全額對沖且衍生品虧損 <1% NAV<br>• 5分: 部分對沖<br>• 0分: 未對沖且外幣曝險過高", "• 基礎貨幣為美元 (USD)[cite: 4]<br>• 提供全套對沖股份類別 (AUD H / EUR H / GBP H / JPY H)[cite: 4]<br>👉 避險機制完善，符合 10 分規則。[cite: 4]", "10 / 10", "<span class='status-badge-green'>✔ 優秀</span>"],
            ["八、區域風險", "單一區域/國家持倉集中度", "• 5分: 單一區域 <40%<br>• 2.5分: 單一區域 40%-60%<br>• 0分: 單一區域 >60%", "• 北美/美國企業占比：80.8% (> 60%)[cite: 4]<br>👉 落在 > 60% 規則區間，符合 0 分規則。[cite: 4]", "0 / 5", "<span class='status-badge-red'>🚨 高度區域集中</span>"],
