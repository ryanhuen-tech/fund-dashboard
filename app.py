...
# 3. 預設資料庫 (加入專屬代號 Z18, ZU6, Z15, Z13)
PRESET_FUNDS = {
    ...
    "ZU6 瑞銀資產管理 - 瑞銀歐元高收益債券基金": {
        ...
        "eval_table": [
            ["一、派息質量", "從資本派息 (ROC) 與總回報覆蓋率", "• 20分: ROC <10% 或 總回報 ≥ 派息率<br>• 10分: ROC 10%-50% 且總回報覆蓋率 >70%<br>• 0分: ROC >50% 且 總回報為負", "• 月報到期收益率：4.50% | 美元對沖派息率：~7.90%<br>• 每月分派高度依賴資本 (ROC 占 70%-100%)<br>👉 單月分派資本補貼偏高，但全年度營運淨利 (€1.08億) 遠高於總派息 (€3,839萬)。", "10 / 20", "<span class='status-badge-yellow'>⚠️ 資本補貼分派</span>"],
