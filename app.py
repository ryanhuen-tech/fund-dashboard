...
PRESET_FUNDS = {
    "Z13 富達基金 - 美元高收益基金": {
        ...
        "company_profile": [
            ...
            "<b>全方位資產管理</b>：專精於股票、固定收益、多元資產及退休金管理，長年榮獲多項理柏 (Refinitiv Lipper) 國際基金大獎。 <i>[出處：Refinitiv Lipper Fund Awards Official]</i>"
        ],
        "score": "82.5",
    ...
    "Z15 霸菱環球高收益債券基金": {
        ...
        "eval_table": [
            ...
            ["九、總開支比率", "每年管理費 (Management Fee)", "• 5分: 管理費 <1.0%<br>• 2.5分: Management Fee 1.0%-1.5%<br>• 0分: Management Fee >1.5%", "• G類別 (零售)：1.25% / 年<br>👉 屬於市場高收益債券基金的標準合理收費區間。", "2.5 / 5", "<span class='status-badge-yellow'>⚠️ 中等</span>"]
        ]
    },
    ...
    "Z29 資本集團 - 資本集團全球公司債券基金": {
        ...
        "score": "77.5",
        "summary": "資本集團全球公司債券基金依據簡算規則審視得分為 77.5 分 (高質感投資級/中高健康度)。年化派息率 4.77% 低於到期收益率 6.50%，且近 12 個月多數 100% 來自營運淨收益 (0% ROC)；全年度淨收益 ($1.618億) 243% 超額覆蓋總派息 ($6,642萬)；全年度呈現 +$21.36 億美元龐大淨資金流入；主要扣分項為久期 6.5 年 與美國區域集中 (61.39%)。",
        "kpis": {
            "p1": "4.77%",
        ...
        "eval_table": [
            ["一、派息質量", "從資本派息 (ROC) 與總回報覆蓋率", "• 20分: ROC <10% 或 總回報 ≥ 派息率<br>• 10分: ROC 10%-50% 且總回報覆蓋率 >70%<br>• 0分: ROC >50% 且 總回報為負", "• 月報到期收益率：6.50% | 美元派息率：~4.77%<br>• 淨利息收益 ($1.618億) 243% 超額覆蓋總派息 ($6,642萬)<br>👉 近乎 100% 由營運淨收益分派，符合滿分 20 分規則。", "20 / 20", "<span class='status-badge-green'>✔ 優秀覆蓋</span>"],
            ["二、信用風險", "評級分佈與非投資級占比", "• 15分: 平均評級 BBB 以上<br>• 10分: 平均評級 BB 級<br>• 5分: Caa/CCC級 >10% 或未評級 >15%", "• 綜合平均評級：A 級 (投資級別 >99.8%)<br>• A / AA 級占逾 50%、BBB 級占 40.9%<br>👉 符合簡算規則 15 分最高級別 (平均評級 BBB 以上)。", "15 / 15", "<span class='status-badge-green'>✔ 高品質投資級</span>"],
            ["三、槓桿水平", "資產膨脹率 (Total / Net Assets)", "• 15分: 比率 <105% (無顯著槓桿)<br>• 10分: 比率 105%-120%<br>• 0分: 比率 >120% (槓桿過高)", "• 總資產 $5,515.94M / 淨資產 $5,485.75M = 100.55%<br>👉 比率 < 105%，完全無顯著借貸槓桿。", "15 / 15", "<span class='status-badge-green'>✔ 優秀</span>"],
            ["四、利率敏感度", "有效存續期 (Duration)", "• 10分: 存續期 <3 年 (抗升息)<br>• 5分: 存續期 3-6 年<br>• 0分: 存續期 >6 年", "• 有效存續期 (Effective Duration)：6.50 年<br>👉 存續期 > 6 年，落在 0 分規則區間 (對利率敏感)。", "0 / 10", "<span class='status-badge-red'>🚨 久期偏長</span>"],
            ["五、流動性風險", "現金儲備與營運現金流", "• 10分: 現金 >10% 或流動性充沛且營運 Cash Flow 為正<br>• 5分: 現金 5%-10%<br>• 0分: 現金 <5% 或流動性緊縮", "• 銀行存款 4.76% ($1.88 億) + 全年淨流入 +$21.36 億美元<br>👉 手持現金略小於 5% 門檻，符合 5 分規則。", "5 / 10", "<span class='status-badge-yellow'>⚠️ 現金比例低</span>"],
            ["六、集中度風險", "前十大發行人持倉占比", "• 10分: 前持倉 <20% (極分散)<br>• 5分: 前持倉 20%-30%<br>• 0分: 前持倉 >30%", "• 前十大發行人持倉合計占：15.80%<br>👉 持倉極度分散 (< 20%)，符合 10 分滿分規則。", "10 / 10", "<span class='status-badge-green'>✔ 極度分散</span>"],
            ["七、匯率風險", "衍生品對沖與未實現損益", "• 10分: 全額對沖且衍生品虧損 <1% NAV<br>• 5分: 部分對沖<br>• 0分: 未對沖且外幣曝險過高", "• 基礎貨幣為美元 (USD)<br>• 提供全套對沖股份類別 (EUR H / GBP H / SGD H 等)<br>👉 避險機制完善，符合 10 分規則。", "10 / 10", "<span class='status-badge-green'>✔ 優秀</span>"],
            ["八、區域風險", "單一區域/國家持倉集中度", "• 5分: 單一區域 <40%<br>• 2.5分: 單一區域 40%-60%<br>• 0分: 單一區域 >60%", "• 美國企業占比：61.39% (> 60%)<br>👉 落在 > 60% 規則區間，符合 0 分規則。", "0 / 5", "<span class='status-badge-red'>🚨 美國區域集中</span>"],
            ["九、總開支比率", "每年管理費 (Management Fee)", "• 5分: 管理費 <1.0%<br>• 2.5分: 管理費 1.0%-1.5%<br>• 0分: Management Fee >1.5%", "• 零售 B / Bfdm 類別總開支率 (TER)：約 1.01% - 1.10% / 年<br>👉 落在 1.0%-1.5% 規則區間，符合 2.5 分規則。", "2.5 / 5", "<span class='status-badge-yellow'>⚠️ 中等</span>"]
        ]
    },
    ...
    "Z52 友邦保險 - 友邦美國高收益債券基金": {
        ...
        "score": "67.5",
        "summary": "友邦美國高收益債券基金依據簡算規則審視得分為 67.5 分 (中等風險/健康)。派息率 7.23% 高於市場平均收益率，部分月份資本分派 (ROC) 達 15%~92%[cite: 8]；但在全基金層面，營運淨收益 ($928.8萬) 完全覆蓋全全基金派息 ($397.0萬)；全年度呈現 +$2,577.9 萬美元淨資金流入；底層 99.87% 債券具 Level 1 高級市場流動性[cite: 7]；手持現金 1.7%[cite: 7]、前十大持倉 25.3%[cite: 7] 及美國區域集中 (77.0%)[cite: 7] 反映在中等扣分項上。",
        "kpis": {
            "p1": "7.23%",
        ...
        "eval_table": [
            ["一、派息質量", "從資本派息 (ROC) 與總回報覆蓋率", "• 20分: ROC <10% 或 總回報 ≥ 派息率<br>• 10分: ROC 10%-50% 且總回報覆蓋率 >70%<br>• 0分: ROC >50% 且 總回報為負", "• 美國高收益債 YTM：~6.50% | 現時派息率：~7.23%<br>• 每月分派部分月份依賴資本 (ROC 占 15%~92%)[cite: 8]<br>👉 單月分派資本補貼偏高，但全年度營運淨利 ($928.8萬) 覆蓋總派息 ($397.0萬)。", "10 / 20", "<span class='status-badge-yellow'>⚠️ 資本補貼分派</span>"],
