...
with ctrl_col2:
    fund_type = st.selectbox("📌 基金類型設定：", ["債券型基金", "股票型基金", "股債混合基金"], index=0)
...
if fund_type == "債券型基金":
    ...
    <div class="kpi-container">
        <div class="kpi-card">
            ...
            <div class="kpi-value-row"><span class="kpi-value">{curr_fund['score']}</span><span class="kpi-subtext">/ 100</span></div>
            <div class="badge-green">✔ 健康 (整體財務結構良好)</div>
        </div>
        <div class="kpi-card">
            <div class="kpi-title">資產槓桿水平</div>
            <div class="kpi-value-row"><span class="kpi-value">{curr_fund['kpi_leverage']}</span></div>
            <div class="badge-green">✔ 優秀 (無顯著借貸槓桿)</div>
        </div>
        <div class="kpi-card">
            <div class="kpi-title">現金與流動性</div>
            <div class="kpi-value-row"><span class="kpi-value">{curr_fund['kpi_cash']}</span></div>
            <div class="badge-green">✔ 優秀 (~5.5億美元現金儲備)</div>
        </div>
        <div class="kpi-card">
            <div class="kpi-title">從資本派息 (ROC) 狀況</div>
            <div class="kpi-value-row"><span class="kpi-value">{curr_fund['kpi_roc']}</span></div>
    ...
    <div class="kpi-container">
        <div class="kpi-card">
            <div class="kpi-title">{fund_type}風險評分</div>
            <div class="kpi-value-row"><span class="kpi-value">待核對</span><span class="kpi-subtext">/ 100</span></div>
            <div class="badge-green">📋 請上傳 PDF 核對數據</div>
        </div>
        <div class="kpi-card">
            <div class="kpi-title">市場敏感度 (Beta / 波幅)</div>
            <div class="kpi-value-row"><span class="kpi-value">待核對</span></div>
            <div class="badge-green">對照基準大盤</div>
        </div>
        <div class="kpi-card">
        ...
        <div class="kpi-card">
            ...
            <div class="kpi-value-row"><span class="kpi-value">待核對</span></div>
            <div class="badge-green">夏普比率</div>
        </div>
    </div>
    """, unsafe_allow_html=True)
...
with col_left:
    ...
    with tab1:
        if fund_type != "債券型基金":
            ...
            fig_radar.update_layout(height=420, margin=dict(l=20, r=20, t=20, b=20), polar=dict(radialaxis=dict(visible=True, range=[0, 20], showticklabels=False)))
