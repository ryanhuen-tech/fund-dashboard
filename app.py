...
PRESET_FUNDS = {
    ...
    "Z18 富蘭克林鄧普頓 - 富蘭克林入息基金": {
        ...
        "score": "67.5",
        "summary": "富蘭克林入息基金依據簡算規則審視得分為 67.5 分 (中等風險)。純經常性利息淨收益 ($3.50億) 對總派息 ($5.73億) 覆蓋率為 61.1%，存在 $2.23 億缺口，需依賴股票資本利得 (Capital Gains) 或本金補充[cite: 1, 2]；申購 $66.73 億 vs 贖回 $34.23 億展現 +$3,249.83M 淨資金流入 (流動性極佳)[cite: 2]；存續期 4.24 年、前十大持倉 23.27% 及美國區域集中 (80.8%) 均反映在中等扣分項上[cite: 2]。",
        "kpis": {
            "p1": "8.37%",
        ...
        "eval_table": [
            ["一、派息質量", "從資本派息 (ROC) 與總回報覆蓋率", "• 20分: ROC <10% 或 總回報 ≥ 派息率<br>• 10分: ROC 10%-50% 且總回報覆蓋率 >70%<br>• 0分: ROC >50% 且 總回報為負", "• 月報到期收益率：6.11% | 現時派息率：~8.37%[cite: 1, 2]<br>• 經常性收益 ($3.50億) 對總派息 ($5.73億) 覆蓋率為 61.1% (< 70%)[cite: 2]<br>👉 經常性利息不足以全額支付派息，需依賴股票資本利得 (Capital Gains) 補足。[cite: 1, 2]", "10 / 20", "<span class='status-badge-yellow'>⚠️ 資本利得補貼/缺口</span>"],
            ["二、信用風險", "評級分佈與非投資級占比", "• 15分: 平均評級 BBB 以上<br>• 10分: 平均評級 BB 級<br>• 5分: Caa/CCC級 >10% 或未評級 >15%", "• 綜合平均評級：BB 級<br>• 高收益債占 19.17%[cite: 2]<br>👉 符合簡算規則 10 分級別 (平均評級 BB 級)。", "10 / 15", "<span class='status-badge-yellow'>⚠️ 中等風險</span>"],
            ["三、槓桿水平", "資產膨脹率 (Total / Net Assets)", "• 15分: 比率 <105% (無顯著槓桿)<br>• 10分: 比率 105%-120%<br>• 0分: 比率 >120% (槓桿過高)", "• 總資產 $8,878.70M / 淨資產 $8,817.35M = 100.69%[cite: 2]<br>👉 比率 < 105%，完全無顯著借貸槓桿。[cite: 2]", "15 / 15", "<span class='status-badge-green'>✔ 優秀</span>"],
            ["四、利率敏感度", "有效存續期 (Duration)", "• 10分: 存續期 <3 年 (抗升息)<br>• 5分: 存續期 3-6 年<br>• 0分: 存續期 >6 年", "• 有效存續期 (Effective Duration)：4.24 年[cite: 2]<br>👉 落在 3-6 年規則區間，符合 5 分規則。[cite: 2]", "5 / 10", "<span class='status-badge-yellow'>⚠️ 中等久期</span>"],
            ["五、流動性風險", "現金儲備與營運現金流", "• 10分: 現金 >10% 或流動性充沛且營運 Cash Flow 為正<br>• 5分: 現金 5%-10%<br>• 0分: 現金 <5% 或流動性緊縮", "• 現金 5.97% + 申購淨流入達 +$32.5 億美元[cite: 2]<br>👉 營運現金流極度充沛，符合 10 分規則。[cite: 2]", "10 / 10", "<span class='status-badge-green'>✔ 優秀</span>"],
            ["六、集中度風險", "前十大發行人持倉占比", "• 10分: 前持倉 <20% (極分散)<br>• 5分: 前持倉 20%-30%<br>• 0分: 前持倉 >30%", "• 前十大發行人持倉合計占：23.27%[cite: 2]<br>👉 落在 20%-30% 規則區間，符合 5 分規則。[cite: 2]", "5 / 10", "<span class='status-badge-yellow'>⚠️ 適中分散</span>"],
            ["七、匯率風險", "衍生品對沖與未實現損益", "• 10分: 全額對沖且衍生品虧損 <1% NAV<br>• 5分: 部分對沖<br>• 0分: 未對沖且外幣曝險過高", "• 基礎貨幣為美元 (USD)[cite: 2]<br>• 提供全套對沖股份類別 (AUD H / EUR H / GBP H / JPY H)[cite: 2]<br>👉 避險機制完善，符合 10 分規則。[cite: 2]", "10 / 10", "<span class='status-badge-green'>✔ 優秀</span>"],
            ["八、區域風險", "單一區域/國家持倉集中度", "• 5分: 單一區域 <40%<br>• 2.5分: 單一區域 40%-60%<br>• 0分: 單一區域 >60%", "• 北美/美國企業占比：80.8% (> 60%)[cite: 2]<br>👉 落在 > 60% 規則區間，符合 0 分規則。[cite: 2]", "0 / 5", "<span class='status-badge-red'>🚨 高度區域集中</span>"],
    ...
    "Z29 資本集團 - 資本集團全球公司債券基金": {
        ...
        "company_profile": [
            "<b>全球歷史最悠久巨擘</b>：成立於 1931 年，總部位於美國加州洛杉磯，為全球規模最大的私營員工持股資產管理公司之一。 <i>[出處：Capital Group Overview]</i>",
            "<b>資產規模超群</b>：全球資產管理總總額 (AUM) 超過 2.6 萬億美元 (USD 2.6+ Trillion)。 <i>[出處：Capital Group Global AUM]</i>",
            "<b>獨創 Capital System™ 體系</b>：多位資深經理人獨立研究與協同管理，有效分散單一決策風險並拉平波動。 <i>[出處：Capital System Architecture]</i>",
            "<b>高品質投資級專家</b>：精專於全球投資級企業債券與多資產研究，擁有獨立強大的信用評級分析團隊。 <i>[出處：Capital Group Fixed Income]</i>"
        ],
        "score": "77.5",
        "summary": "資本集團全球公司債券基金依據簡算規則審視得分為 77.5 分 (高質感投資級/中高健康度)。年化派息率 4.77%[cite: 6] 低於到期收益率 6.50%[cite: 1]，且近 12 個月多數 100% 來自營運淨收益 (0% ROC)[cite: 6]；全年度淨收益 ($1.618億) 243% 超額覆蓋總派息 ($6,642萬)[cite: 4]；全年度呈現 +$21.36 億美元龐大淨資金流入[cite: 4]；主要扣分項為久期 6.5 年[cite: 1] 與美國區域集中 (61.39%)[cite: 2]。",
        "kpis": {
            "p1": "4.77%",
        ...
        "radar_scores": [20.0, 15.0, 15.0, 0.0, 5.0, 10.0, 10.0, 0.0, 2.5],
        "radar_dimensions": ["一、派息質量", "二、信用風險", "三、槓桿水平", "四、利率敏感度", "五、流動性風險", "六、集中度風險", "七、匯率風險", "八、區域風險", "九、總開支比率"],
        "top10": [
            {"排名": 1, "持倉名稱": "Morgan Stanley (摩根士丹利)", "資產類別": "金融/銀行債", "佔比 (%)": "2.00%"},
            {"排名": 2, "持倉名稱": "Oracle Corp (甲骨文)", "資產類別": "科技企業債", "佔比 (%)": "1.80%"},
            {"排名": 3, "持倉名稱": "Ford Motor Credit Company LLC (福特金融)", "資產類別": "汽車金融債", "佔比 (%)": "1.70%"},
            {"排名": 4, "持倉名稱": "Amgen Inc (安進藥廠)", "資產類別": "醫療保健債", "佔比 (%)": "1.70%"},
            {"排名": 5, "持倉名稱": "Verizon Communications (威訊電信)", "資產類別": "電信服務債", "佔比 (%)": "1.60%"},
            {"排名": 6, "持倉名稱": "CaixaBank SA", "資產類別": "金融/銀行債", "佔比 (%)": "1.50%"},
            {"排名": 7, "持倉名稱": "JPMorgan Chase & Co (摩根大通)", "資產類別": "金融/銀行債", "佔比 (%)": "1.50%"},
            {"排名": 8, "持倉名稱": "Synopsys Inc (新思科技)", "資產類別": "科技企業債", "佔比 (%)": "1.40%"},
            {"排名": 9, "持倉名稱": "BPCE SA", "資產類別": "金融/銀行債", "佔比 (%)": "1.30%"},
            {"排名": 10, "持倉名稱": "Charter Communications Operating", "資產類別": "媒體/電信債", "佔比 (%)": "1.30%"},
        ],
        "history_div": [
        ...
        "eval_table": [
            ["一、派息質量", "從資本派息 (ROC) 與總回報覆蓋率", "• 20分: ROC <10% 或 總回報 ≥ 派息率<br>• 10分: ROC 10%-50% 且總回報覆蓋率 >70%<br>• 0分: ROC >50% 且 總回報為負", "• 月報到期收益率：6.50% | 美元派息率：~4.77%[cite: 1, 6]<br>• 淨利息收益 ($1.618億) 243% 超額覆蓋總派息 ($6,642萬)[cite: 4]<br>👉 近乎 100% 由營運淨收益分派，符合滿分 20 分規則。[cite: 6]", "20 / 20", "<span class='status-badge-green'>✔ 優秀覆蓋</span>"],
            ["二、信用風險", "評級分佈與非投資級占比", "• 15分: 平均評級 BBB 以上<br>• 10分: 平均評級 BB 級<br>• 5分: Caa/CCC級 >10% 或未評級 >15%", "• 綜合平均評級：A 級 (投資級別 >99.8%)[cite: 1]<br>• A / AA 級占逾 50%[cite: 1]、BBB 級占 40.9%[cite: 1]<br>👉 符合簡算規則 15 分最高級別 (平均評級 BBB 以上)。", "15 / 15", "<span class='status-badge-green'>✔ 高品質投資級</span>"],
            ["三、槓桿水平", "資產膨脹率 (Total / Net Assets)", "• 15分: 比率 <105% (無顯著槓桿)<br>• 10分: 比率 105%-120%<br>• 0分: 比率 >120% (槓桿過高)", "• 總資產 $5,515.94M / 淨資產 $5,485.75M = 100.55%[cite: 3]<br>👉 比率 < 105%，完全無顯著借貸槓桿。[cite: 3]", "15 / 15", "<span class='status-badge-green'>✔ 優秀</span>"],
            ["四、利率敏感度", "有效存續期 (Duration)", "• 10分: 存續期 <3 年 (抗升息)<br>• 5分: 存續期 3-6 年<br>• 0分: 存續期 >6 年", "• 有效存續期 (Effective Duration)：6.50 年[cite: 1]<br>👉 存續期 > 6 年，落在 0 分規則區間 (對利率敏感)。[cite: 1]", "0 / 10", "<span class='status-badge-red'>🚨 久期偏長</span>"],
            ["五、流動性風險", "現金儲備與營運現金流", "• 10分: 現金 >10% 或流動性充沛且營運 Cash Flow 為正<br>• 5分: 現金 5%-10%<br>• 0分: 現金 <5% 或流動性緊縮", "• 銀行存款 4.76% ($1.88 億)[cite: 3] + 全年淨流入 +$21.36 億美元[cite: 4]<br>👉 手持現金略小於 5% 門檻，符合 5 分規則。[cite: 1, 2, 3]", "5 / 10", "<span class='status-badge-yellow'>⚠️ 現金比例低</span>"],
            ["六、集中度風險", "前十大發行人持倉占比", "• 10分: 前持倉 <20% (極分散)<br>• 5分: 前持倉 20%-30%<br>• 0分: 前持倉 >30%", "• 前十大發行人持倉合計占：15.80%[cite: 1]<br>👉 持倉極度分散 (< 20%)，符合 10 分滿分規則。[cite: 1]", "10 / 10", "<span class='status-badge-green'>✔ 極度分散</span>"],
            ["七、匯率風險", "衍生品對沖與未實現損益", "• 10分: 全額對沖且衍生品虧損 <1% NAV<br>• 5分: 部分對沖<br>• 0分: 未對沖且外幣曝險過高", "• 基礎貨幣為美元 (USD)[cite: 1, 3]<br>• 提供全套對沖股份類別 (EUR H / GBP H / SGD H 等)[cite: 1, 3]<br>👉 避險機制完善，符合 10 分規則。[cite: 1, 3]", "10 / 10", "<span class='status-badge-green'>✔ 優秀</span>"],
            ["八、區域風險", "單一區域/國家持倉集中度", "• 5分: 單一區域 <40%<br>• 2.5分: 單一區域 40%-60%<br>• 0分: 單一區域 >60%", "• 美國企業占比：61.39% (> 60%)[cite: 2]<br>👉 落在 > 60% 規則區間，符合 0 分規則。[cite: 2]", "0 / 5", "<span class='status-badge-red'>🚨 美國區域集中</span>"],
            ["九、總開支比率", "每年管理費 (Management Fee)", "• 5分: 管理費 <1.0%<br>• 2.5分: 管理費 1.0%-1.5%<br>• 0分: Management Fee >1.5%", "• 零售 B / Bfdm 類別總開支率 (TER)：約 1.01% - 1.10% / 年[cite: 4]<br>👉 落在 1.0%-1.5% 規則區間，符合 2.5 分規則。[cite: 4]", "2.5 / 5", "<span class='status-badge-yellow'>⚠️ 中等</span>"]
        ]
    },
    ...
    "Z52 友邦保險 - 友邦美國高收益債券基金": {
        ...
        "company_profile": [
            "<b>亞太壽險巨擘子公司</b>：成立於 2019 年（母公司友邦保險 1299.HK 創立於 1919 年），為友邦保險集團旗下的專業資產管理機構。 <i>[出處：AIA Corporate Overview]</i>",
            "<b>資產規模強勁</b>：專為友邦保險集團及獨立基金進行全球配置，管理資產總額 (AUM) 超過 3,000 億美元。 <i>[出處：AIA Group Financial Report]</i>",
            "<b>主打機構級審慎風控</b>：承襲保險資金的審慎投資基因，以嚴謹的風險預算與基本面研究管理固定收益組合。 <i>[出處：AIA Investment Philosophy]</i>",
            "<b>雙重嚴格金融監管</b>：UCITS 旗艦基金發行註冊於盧森堡，受盧森堡 CSSF 及香港 SFC 雙重嚴格監督。 <i>[出處：SFC / CSSF UCITS]</i>"
        ],
        "score": "67.5",
        "summary": "友邦美國高收益債券基金依據簡算規則審視得分為 67.5 分 (中等風險/健康)。派息率 7.23%[cite: 8] 高於市場平均收益率，部分月份資本分派 (ROC) 達 15%~92%[cite: 8]；但在全基金層面，營運淨收益 ($928.8萬) 完全覆蓋全全基金派息 ($397.0萬)；全年度呈現 +$2,577.9 萬美元淨資金流入；底層 99.87% 債券具 Level 1 高級市場流動性[cite: 7]；手持現金 1.7%[cite: 7]、前十大持倉 25.3%[cite: 7] 及美國區域集中 (77.0%)[cite: 7] 反映在中等扣分項上。",
        "kpis": {
            "p1": "7.23%",
        ...
        "radar_scores": [10.0, 10.0, 15.0, 5.0, 5.0, 5.0, 10.0, 0.0, 2.5],
        "radar_dimensions": ["一、派息質量", "二、信用風險", "三、槓桿水平", "四、利率敏感度", "五、流動性風險", "六、集中度風險", "七、匯率風險", "八、區域風險", "九、總開支比率"],
        "top10": [
            {"排名": 1, "持倉名稱": "CBT US 10YR NOTE (CBT) Sep26 (10年國債期貨)", "資產類別": "國債期貨合約", "佔比 (%)": "5.40%"},
            {"排名": 2, "持倉名稱": "CDS BRC 5% 20/06/31 (信用違約掉期)", "資產類別": "信用衍生工具", "佔比 (%)": "5.20%"},
            {"排名": 3, "持倉名稱": "CBT US 2YR NOTE (CBT) Sep26 (2年國債期貨)", "資產類別": "國債期貨合約", "佔比 (%)": "3.50%"},
            {"排名": 4, "持倉名稱": "CBT US ULTRA BOND CBT Sep26 (超長國債期貨)", "資產類別": "國債期貨合約", "佔比 (%)": "2.00%"},
            {"排名": 5, "持倉名稱": "United States Treasury Bill 0% 10-Sep-2026", "資產類別": "美國國庫券", "佔比 (%)": "1.90%"},
            {"排名": 6, "持倉名稱": "CDS BRC 5% 20/12/30 (信用違約掉期)", "資產類別": "信用衍生工具", "佔比 (%)": "1.80%"},
            {"排名": 7, "持倉名稱": "CBT US 10yr Ultra Fut Sep26 (10年超長期貨)", "資產類別": "國債期貨合約", "佔比 (%)": "1.20%"},
            {"排名": 8, "持倉名稱": "United States Treasury Bill 0% 30-Jul-2026", "資產類別": "美國國庫券", "佔比 (%)": "1.20%"},
            {"排名": 9, "持倉名稱": "CDS GOS 5% 20/12/30 (信用違約掉期)", "資產類別": "信用衍生工具", "佔比 (%)": "1.10%"},
            {"排名": 10, "持倉名稱": "United States Treasury Bill 0% 06/08/2026", "資產類別": "美國國庫券", "佔比 (%)": "0.90%"},
        ],
        "history_div": [
        ...
        "eval_table": [
            ["一、派息質量", "從資本派息 (ROC) 與總回報覆蓋率", "• 20分: ROC <10% 或 總回報 ≥ 派息率<br>• 10分: ROC 10%-50% 且總回報覆蓋率 >70%<br>• 0分: ROC >50% 且 總回報為負", "• 美國高收益債 YTM：~6.50% | 現時派息率：~7.23%[cite: 7, 8]<br>• 每月分派部分月份依賴資本 (ROC 占 15%~92%)[cite: 8]<br>👉 單月分派資本補貼偏高，但全年度營運淨利 ($928.8萬) 覆蓋總派息 ($397.0萬)。", "10 / 20", "<span class='status-badge-yellow'>⚠️ 資本補貼分派</span>"],
            ["二、信用風險", "評級分佈與非投資級占比", "• 15分: 平均評級 BBB 以上<br>• 10分: 平均評級 BB 級<br>• 5分: Caa/CCC級 >10% 或未評級 >15%", "• 綜合平均評級：BB 級 (BBB-與BB級提升至59.8%)[cite: 7]<br>• BB 級 43.77%[cite: 7]、B 級 23.44%[cite: 7]、CCC 級 14.08%[cite: 7]<br>👉 符合簡算規則 10 分級別 (平均評級 BB 級)。", "10 / 15", "<span class='status-badge-yellow'>⚠️ 中等風險</span>"],
            ["三、槓桿水平", "資產膨脹率 (Total / Net Assets)", "• 15分: 比率 <105% (無顯著槓桿)<br>• 10分: 比率 105%-120%<br>• 0分: 比率 >120% (槓桿過高)", "• 總資產 $130,143,158 / 淨資產 $129,879,657 = 100.20%<br>👉 比率 < 105%，完全無顯著借貸槓桿。", "15 / 15", "<span class='status-badge-green'>✔ 優秀</span>"],
            ["四、利率敏感度", "有效存續期 (Duration)", "• 10分: 存續期 <3 年 (抗升息)<br>• 5分: 存續期 3-6 年<br>• 0分: 存續期 >6 年", "• 加權平均有效存續期：約 3.20 年[cite: 7]<br>👉 落在 3-6 年規則區間，符合 5 分規則。[cite: 7]", "5 / 10", "<span class='status-badge-yellow'>⚠️ 中等久期</span>"],
            ["五、流動性風險", "現金儲備與營運現金流", "• 10分: 現金 >10% 或流動性充沛且營運 Cash Flow 為正<br>• 5分: 現金 5%-10%<br>• 0分: 現金 <5% 或流動性緊縮", "• 手持現金 1.70% ($51.27萬)[cite: 7] + 99.87% 屬 Level 1 高度活絡市場資產[cite: 7]<br>👉 手持現金 < 5%，符合 5 分規則。[cite: 7]", "5 / 10", "<span class='status-badge-yellow'>⚠️ 現金比例低</span>"],
            ["六、集中度風險", "前十大發行人持倉占比", "• 10分: 前持倉 <20% (極分散)<br>• 5分: 前持倉 20%-30%<br>• 0分: 前持倉 >30%", "• 前十大持倉/衍生品合約合計占：25.30%[cite: 7]<br>👉 落在 20%-30% 規則區間，符合 5 分規則。[cite: 7]", "5 / 10", "<span class='status-badge-yellow'>⚠️ 適中分散</span>"],
            ["七、匯率風險", "衍生品對沖與未實現損益", "• 10分: 全額對沖且衍生品虧損 <1% NAV<br>• 5分: 部分對沖<br>• 0分: 未對沖且外幣曝險過高", "• 基礎貨幣為美元 (USD)[cite: 7]<br>• 持倉及派息主要均以美元結算[cite: 7, 8]<br>👉 避險機制完善，符合 10 分規則。[cite: 7, 8]", "10 / 10", "<span class='status-badge-green'>✔ 優秀</span>"],
            ["八、區域風險", "單一區域/國家持倉集中度", "• 5分: 單一區域 <40%<br>• 2.5分: 單一區域 40%-60%<br>• 0分: 單一區域 >60%", "• 美國企業占比：77.0% (> 60%)[cite: 7]<br>👉 落在 > 60% 規則區間，符合 0 分規則。[cite: 7]", "0 / 5", "<span class='status-badge-red'>🚨 美國區域集中</span>"],
            ["九、總開支比率", "每年管理費 (Management Fee)", "• 5分: 管理費 <1.0%<br>• 2.5分: 管理費 1.0%-1.5%<br>• 0分: Management Fee >1.5%", "• 每年投資管理費：最高 1.25% / 年[cite: 7]<br>👉 落在 1.0%-1.5% 規則區間，符合 2.5 分規則。[cite: 7]", "2.5 / 5", "<span class='status-badge-yellow'>⚠️ 中等</span>"]
        ]
    },
    ...
    "ZU6 瑞銀資產管理 - 瑞銀歐元高收益債券基金": {
        ...
        "company_profile": [
            "<b>瑞士金融百年龍頭</b>：成立於 1862 年，總部位於瑞士蘇黎世，為全球最頂尖的跨國金融服務集團之一。 <i>[出處：UBS Group Overview]</i>",
            "<b>資產規模破紀錄</b>：併購瑞信 (Credit Suisse) 後，瑞銀集團總管理資產 (AUM) 突破 7 萬億美元 (USD 7+ Trillion)。 <i>[出處：UBS Annual Report]</i>",
            "<b>固定收益深厚實力</b>：在歐洲高收益債、投資級企業債及多元資產領域擁有業界最頂尖的投研與避險團隊。 <i>[出處：UBS AM Fixed Income Insights]</i>",
            "<b>嚴謹風險控管體系</b>：受盧森堡 CSSF 嚴格監管，產品結構透明且流動性管理機制完善。 <i>[出處：UBS Governance]</i>"
        ],
        "score": "75.0",
        "summary": "瑞銀歐元高收益債券基金依據簡算規則審視得分為 75.0 分 (中等風險/健康)。每月分派高度依賴資本補貼 (ROC 占 70%-100%)[cite: 5]；但全基金層面營運淨收益 (+€1.08億) 仍完全覆蓋全全基金派息 (+€3,839萬)[cite: 3]；申購 €13.17 億 vs 贖回 €6.21 億呈現 +€6.95 億歐元強勁淨流入[cite: 3]；久期僅 2.8 年抗升息力強[cite: 3]；持倉極分散 (Top 10 占 22.67%)[cite: 4]。",
        "kpis": {
            "p1": "7.90%",
        ...
        "radar_scores": [10.0, 10.0, 15.0, 10.0, 10.0, 5.0, 10.0, 2.5, 2.5],
        "radar_dimensions": ["一、派息質量", "二、信用風險", "三、槓桿水平", "四、利率敏感度", "五、流動性風險", "六、集中度風險", "七、匯率風險", "八、區域風險", "九、總開支比率"],
        "top10": [
            {"排名": 1, "持倉名稱": "Nidda Healthcare Holding (斯達藥業)", "資產類別": "醫療保健債", "佔比 (%)": "3.30%"},
            {"排名": 2, "持倉名稱": "Teva Pharmaceutical Industries Ltd (泰華製藥)", "資產類別": "醫療保健債", "佔比 (%)": "2.71%"},
            {"排名": 3, "持倉名稱": "Aroundtown S.A (環球地產)", "資產類別": "房地產債", "佔比 (%)": "2.55%"},
            {"排名": 4, "持倉名稱": "CPI Property Group S.A", "資產類別": "房地產債", "佔比 (%)": "2.32%"},
            {"排名": 5, "持倉名稱": "Summer Bidco", "資產類別": "金融/控股債", "佔比 (%)": "2.31%"},
            {"排名": 6, "持倉名稱": "ZF North America Inc (採埃孚)", "資產類別": "汽車零部件債", "佔比 (%)": "2.18%"},
            {"排名": 7, "持倉名稱": "Grifols (基立福)", "資產類別": "醫療保健債", "佔比 (%)": "1.92%"},
            {"排名": 8, "持倉名稱": "Pinnacle Bidco PLC", "資產類別": "服務業債", "佔比 (%)": "1.88%"},
            {"排名": 9, "持倉名稱": "Cirsa Finance International", "資產類別": "休閒娛樂債", "佔比 (%)": "1.80%"},
            {"排名": 10, "持倉名稱": "Altice France SA (法國電信)", "資產類別": "電信服務債", "佔比 (%)": "1.70%"},
        ],
        "history_div": [
        ...
        "eval_table": [
            ["一、派息質量", "從資本派息 (ROC) 與總回報覆蓋率", "• 20分: ROC <10% 或 總回報 ≥ 派息率<br>• 10分: ROC 10%-50% 且總回報覆蓋率 >70%<br>• 0分: ROC >50% 且 總回報為負", "• 月報到期收益率：4.50% | 美元對沖派息率：~7.90%<br>• 每月分派高度依賴資本 (ROC 占 70%-100%)[cite: 5]<br>👉 單月分派資本補貼偏高，但全年度營運淨利 (€1.08億) 遠高於總派息 (€3,839萬)[cite: 3]。", "10 / 20", "<span class='status-badge-yellow'>⚠️ 資本補貼分派</span>"],
            ["二、信用風險", "評級分佈與非投資級占比", "• 15分: 平均評級 BBB 以上<br>• 10分: 平均評級 BB 級<br>• 5分: Caa/CCC級 >10% 或未評級 >15%", "• 綜合平均評級：BB- 級[cite: 4]<br>• BB 級占 47.20%[cite: 4]、B 級占 38.51%[cite: 4]<br>👉 符合簡算規則 10 分級別 (平均評級 BB 級)。", "10 / 15", "<span class='status-badge-yellow'>⚠️ 中等風險</span>"],
            ["三、槓桿水平", "資產膨脹率 (Total / Net Assets)", "• 15分: 比率 <105% (無顯著槓桿)<br>• 10分: 比率 105%-120%<br>• 0分: 比率 >120% (槓桿過高)", "• 總資產 €2,597.48M / 淨資產 €2,569.28M = 101.09%[cite: 3]<br>👉 比率 < 105%，完全無顯著借貸槓桿。[cite: 3]", "15 / 15", "<span class='status-badge-green'>✔ 優秀</span>"],
            ["四、利率敏感度", "有效存續期 (Duration)", "• 10分: 存續期 <3 年 (抗升息)<br>• 5分: 存續期 3-6 年<br>• 0分: 存續期 >6 年", "• 有效存續期 (Effective Duration)：~2.80 年[cite: 3]<br>👉 存續期小於 3 年，符合 10 分規則 (高抗升息力)。[cite: 3]", "10 / 10", "<span class='status-badge-green'>✔ 優秀</span>"],
            ["五、流動性風險", "現金儲備與營運現金流", "• 10分: 現金 >10% 或流動性充沛且營運 Cash Flow 為正<br>• 5分: 現金 5%-10%<br>• 0分: 現金 <5% 或流動性緊縮", "• 銀行存款 6.11% (€1.57 億)[cite: 3] + 申購淨流入 +€6.95 億歐元[cite: 3]<br>👉 營運現金流極度充沛，流動性極優。", "10 / 10", "<span class='status-badge-green'>✔ 優秀</span>"],
            ["六、集中度風險", "前十大發行人持倉占比", "• 10分: 前持倉 <20% (極分散)<br>• 5分: 前持倉 20%-30%<br>• 0分: 前持倉 >30%", "• 前十大發行人持倉合計占：22.67%[cite: 4]<br>👉 落在 20%-30% 規則區間，符合 5 分規則。[cite: 4]", "5 / 10", "<span class='status-badge-yellow'>⚠️ 適中分散</span>"],
            ["七、匯率風險", "衍生品對沖與未實現損益", "• 10分: 全額對沖且衍生品虧損 <1% NAV<br>• 5分: 部分對沖<br>• 0分: 未對沖且外幣曝險過高", "• 基礎貨幣為歐元 (EUR)[cite: 3, 4]<br>• 提供全套對沖股份類別 (USD H / CHF H / AUD H 等)[cite: 3, 4]<br>👉 避險機制完善，符合 10 分規則。[cite: 3, 4]", "10 / 10", "<span class='status-badge-green'>✔ 優秀</span>"],
            ["八、區域風險", "單一區域/國家持倉集中度", "• 5分: 單一區域 <40%<br>• 2.5分: 單一區域 40%-60%<br>• 0分: 單一區域 >60%", "• 歐洲多國合計占 > 80%[cite: 3]<br>👉 雖然分散於盧森堡、英國、法國等國，但屬歐洲單一區域。[cite: 3]", "2.5 / 5", "<span class='status-badge-yellow'>⚠️ 區域集中</span>"],
            ["九、總開支比率", "每年管理費 (Management Fee)", "• 5分: 管理費 <1.0%<br>• 2.5分: 管理費 1.0%-1.5%<br>• 0分: Management Fee >1.5%", "• 零售 P 類別總開支率 (TER)：約 1.01% - 1.05% / 年[cite: 4]<br>👉 落在 1.0%-1.5% 規則區間，符合 2.5 分規則。[cite: 4]", "2.5 / 5", "<span class='status-badge-yellow'>⚠️ 中等</span>"]
        ]
    }
}
