...
# 3. 預設資料庫 (按代號 Z13, Z15, Z18, Z29, ZU6 由細至大排序)
PRESET_FUNDS = {
    "Z13 富達基金 - 美元高收益基金": {
        "code": "Z13",
        "zh": "富達基金 - 美元高收益基金",
    ...
    "Z15 霸菱環球高收益債券基金": {
        ...
        "kpis": {
            ...
            "p11": "+$640.00 M", "p11_delta": "🟢 申購 - 贖回 (淨流出)", "p11_color": "normal"
        },
        "radar_scores": [15.0, 10.0, 15.0, 10.0, 10.0, 10.0, 10.0, 0.0, 2.5],
        "radar_dimensions": ["一、派息質量", "二、信用風險", "三、槓桿水平", "四、利率敏感度", "五、流動性風險", "六、集中度風險", "七、匯率風險", "八、區域風險", "九、總開支比率"],
        "top10": [
        ...
        "eval_table": [
            ...
            ["九、總開支比率", "每年管理費 (Management Fee)", "• 5分: 管理費 <1.0%<br>• 2.5分: Management Fee 1.0%-1.5%<br>• 0分: Management Fee >1.5%", "• G類別 (零售)：1.25% / 年<br>👉 屬於市場高收益債券基金的標準收費區間。", "2.5 / 5", "<span class='status-badge-yellow'>⚠️ 中等</span>"]
        ]
    },
    ...
    "Z29 資本集團 - 資本集團全球公司債券基金": {
        ...
        "score": "77.5", # 💡 嚴格遵循規則點算後得分為 77.5 分
    ...
    "ZU6 瑞銀資產管理 - 瑞銀歐元高收益債券基金": {
        ...
        "score": "75.0",
        "summary": "瑞銀歐元高收益債券基金依據簡算規則審視得分為 75.0 分 (中等風險/健康)。每月分派高度依賴資本補貼 (ROC 占 70%-100%)；但全基金層面營運淨收益 (+€1.08億) 仍完全覆蓋全全基金派息 (+€3,839萬)；申購 €13.17 億 vs 贖回 €6.21 億呈現 +€6.95 億歐元強勁淨流入；久期僅 2.8 年抗升息力強；持倉極分散 (Top 10 占 22.67%)。",
        "kpis": {
            "p1": "7.90%",
        ...
        "eval_table": [
            ["一、派息質量", "從資本派息 (ROC) 與總回報覆蓋率", "• 20分: ROC <10% 或 總回報 ≥ 派息率<br>• 10分: ROC 10%-50% 且總回報覆蓋率 >70%<br>• 0分: ROC >50% 且 總回報為負", "• 月報到期收益率：4.50% | 美元對沖派息率：~7.90%<br>• 每月分派高度依賴資本 (ROC 占 70%-100%)[cite: 5]<br>👉 單月分派資本補貼偏高，但全年度營運淨利 (€1.08億) 遠高於總派息 (€3,839萬)。", "10 / 20", "<span class='status-badge-yellow'>⚠️ 資本補貼分派</span>"],
            ["二、信用風險", "評級分佈與非投資級占比", "• 15分: 平均評級 BBB 以上<br>• 10分: 平均評級 BB 級<br>• 5分: Caa/CCC級 >10% 或未評級 >15%", "• 綜合平均評級：BB- 級<br>• BB 級占 47.20%、B 級占 38.51%<br>👉 符合簡算規則 10 分級別 (平均評級 BB 級)。", "10 / 15", "<span class='status-badge-yellow'>⚠️ 中等風險</span>"],
            ["三、槓桿水平", "資產膨脹率 (Total / Net Assets)", "• 15分: 比率 <105% (無顯著槓桿)<br>• 10分: 比率 105%-120%<br>• 0分: 比率 >120% (槓桿過高)", "• 總資產 €2,597.48M / 淨資產 €2,569.28M = 101.09%<br>👉 比率 < 105%，完全無顯著借貸槓桿。", "15 / 15", "<span class='status-badge-green'>✔ 優秀</span>"],
            ["四、利率敏感度", "有效存續期 (Duration)", "• 10分: 存續期 <3 年 (抗升息)<br>• 5分: 存續期 3-6 年<br>• 0分: 存續期 >6 年", "• 有效存續期 (Effective Duration)：~2.80 年<br>👉 存續期小於 3 年，符合 10 分規則 (高抗升息力)。", "10 / 10", "<span class='status-badge-green'>✔ 優秀</span>"],
            ["五、流動性風險", "現金儲備與營運現金流", "• 10分: 現金 >10% 或流動性充沛且營運 Cash Flow 為正<br>• 5分: 現金 5%-10%<br>• 0分: 現金 <5% 或流動性緊縮", "• 銀行存款 6.11% (€1.57 億) + 申購淨流入 +€6.95 億歐元<br>👉 營運現金流極度充沛，流動性極優。", "10 / 10", "<span class='status-badge-green'>✔ 優秀</span>"],
            ["六、集中度風險", "前十大發行人持倉占比", "• 10分: 前持倉 <20% (極分散)<br>• 5分: 前持倉 20%-30%<br>• 0分: 前持倉 >30%", "• 前十大發行人持倉合計占：22.67%<br>👉 落在 20%-30% 規則區間，符合 5 分規則。", "5 / 10", "<span class='status-badge-yellow'>⚠️ 適中分散</span>"],
            ["七、匯率風險", "衍生品對沖與未實現損益", "• 10分: 全額對沖且衍生品虧損 <1% NAV<br>• 5分: 部分對沖<br>• 0分: 未對沖且外幣曝險過高", "• 基礎貨幣為歐元 (EUR)<br>• 提供全套對沖股份類別 (USD H / CHF H / AUD H 等)<br>👉 避險機制完善，符合 10 分規則。", "10 / 10", "<span class='status-badge-green'>✔ 優秀</span>"],
            ["八、區域風險", "單一區域/國家持倉集中度", "• 5分: 單一區域 <40%<br>• 2.5分: 單一區域 40%-60%<br>• 0分: 單一區域 >60%", "• 歐洲多國合計占 > 80%<br>👉 雖然分散於盧森堡、英國、法國等國，但屬歐洲單一區域。", "2.5 / 5", "<span class='status-badge-yellow'>⚠️ 區域集中</span>"],
            ["九、總開支比率", "每年管理費 (Management Fee)", "• 5分: 管理費 <1.0%<br>• 2.5分: 管理費 1.0%-1.5%<br>• 0分: Management Fee >1.5%", "• 零售 P 類別總開支率 (TER)：約 1.01% - 1.05% / 年<br>👉 落在 1.0%-1.5% 規則區間，符合 2.5 分規則。", "2.5 / 5", "<span class='status-badge-yellow'>⚠️ 中等</span>"]
        ]
    }
}
...
with st.expander("📋 點擊展開 / 折疊：基金深度風險評估明細表", expanded=True):
    ...
    <div class="summary-footer">
        ...
        <span class="status-badge-yellow" style="font-size: 13px; padding: 5px 12px;">{curr_fund['score']}% (中高健康度/高品質)</span>
    </div>
    """
